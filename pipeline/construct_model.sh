...
GET_MEDIAN=/home/rcf-40/mengzhou/scripts/computing/get_median.awk
NTHREAD=16

# file names involved in this program
NHMMER_OUT=""
INIT_PROMOTER=""
...
function trf_by_revcomp() {
  ...
  $TRF_PROG $INPUT_REV $TRF_PARS > ${NAME}.rev.monomers.list
...
function scan_rpmm() {
  ...
  OUT_PREFIX=$3
  echo "[SCANNING]"
  $RPHMM/scan -v -p $NTHREAD -c $IN_FA -o ${OUT_PREFIX}.scan $MODEL
